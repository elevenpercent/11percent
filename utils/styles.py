...
[data-testid="stSidebarUserContent"] {
    ...
    max-width:0!important; opacity:0!important; visibility:hidden!important;
...
/* Hide default white flash */
html { background:#13161a !important; }
body { background:#13161a !important; }

/* ── Base ── */
html, body,
[data-testid="stAppViewContainer"],
[data-testid="stAppViewContainer"] > .main,
.main .block-container { background:#13161a !important; }
...
.page-hero p {
    ...
    line-height:1.8; max-width:580px; margin:0;
}
...
.metric-lbl {
    ...
    letter-spacing:0.2em; color:var(--dim); margin-top:0.3rem;
}
.metric-sub { font-family:'IBM Plex Mono',monospace; font-size:0.6rem; color:var(--muted); margin-top:0.15rem; }

/* ── Info / warn ── */
.info-box  { background:rgba(96,165,250,0.05);  border:1px solid rgba(96,165,250,0.2);  border-radius:8px; padding:0.75rem 1rem; font-size:0.77rem; color:var(--muted); line-height:1.6; }
.warn-box  { background:rgba(251,191,36,0.05);  border:1px solid rgba(251,191,36,0.2);  border-radius:8px; padding:0.75rem 1rem; font-size:0.77rem; color:var(--muted); line-height:1.6; }
.success-box { background:rgba(74,222,128,0.05); border:1px solid rgba(74,222,128,0.2); border-radius:8px; padding:0.75rem 1rem; font-size:0.77rem; color:var(--muted); line-height:1.6; }
...
.tag-green { background:rgba(74,222,128,0.1);  color:var(--green); border:1px solid rgba(74,222,128,0.22); }
.tag-red   { background:rgba(248,113,113,0.1); color:var(--red);   border:1px solid rgba(248,113,113,0.22); }
.tag-blue  { background:rgba(96,165,250,0.1);  color:var(--blue);  border:1px solid rgba(96,165,250,0.22); }
.tag-yellow{ background:rgba(251,191,36,0.1);  color:var(--yellow);border:1px solid rgba(251,191,36,0.22); }
...
/* ── Chat bubbles ── */
.chat-user { background:rgba(96,165,250,0.07); border:1px solid rgba(96,165,250,0.15); border-radius:12px 12px 2px 12px; padding:0.75rem 1rem; margin:0.4rem 0; font-size:0.82rem; color:var(--text); line-height:1.6; max-width:85%; margin-left:auto; }
...
.chat-ai code { background:rgba(0,0,0,0.25); border:1px solid var(--border); border-radius:3px; padding:1px 4px; font-family:'IBM Plex Mono',monospace; font-size:0.77rem; color:var(--blue); }
...
.t-sym { color:var(--dim); font-weight:600; }
...
div[data-testid="stButton"] > button[kind="primary"] {
    background:var(--green)!important; border-color:transparent!important;
    color:#0a0f0a!important; font-weight:700!important;
}
div[data-testid="stButton"] > button[kind="primary"]:hover {
    background:#6ee7a0!important; box-shadow:0 0 20px rgba(74,222,128,0.25)!important;
}
...
[data-testid="stTabs"] [role="tab"] {
    ...
    font-weight:600!important; text-transform:uppercase!important;
    letter-spacing:0.14em!important; color:var(--dim)!important;
    border:none!important; border-bottom:2px solid transparent!important;
    background:transparent!important; padding:0.55rem 1.1rem!important;
...
.page-header-eyebrow { font-family:'IBM Plex Mono',monospace; font-size:0.5rem; text-transform:uppercase; letter-spacing:0.3em; color:var(--dim); margin-bottom:0.35rem; }
