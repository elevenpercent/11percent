...
def get_market_status(market_name):
    """Calculates if markets are open based on NY time."""
...
with right:
    ...
    # DYNAMIC MARKET STATUS SECTION
    for name in ["NYSE", "NASDAQ", "CME Futures", "Crypto"]:
        status, col = get_market_status(name)
