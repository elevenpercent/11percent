...
with cols[i%4]:
if p[“type”]==“int”:   params[pk] = st.slider(p[“label”], p[“min”], p[“max”], p[“default”], key=f”{prefix}*{pk}”)
elif p[“type”]==“float”: params[pk] = st.slider(p[“label”], float(p[“min”]), float(p[“max”]), float(p[“default”]), step=0.1, key=f”{prefix}*{pk}”)
return params
